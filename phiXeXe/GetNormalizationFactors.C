...
Int_t  GetNormalizationFactors(TString fileName, TString listNameSuffix = "_tpc2s_tof3sveto")
{
  ...
  Float_t centLowE[5] = {0.0, 30.0, 60.0, 90.0, 100.0};
  ...
  Printf(Form("Normalization array: norm = { %e, %e, %e}", centCounters[0], centCounters[1], centCounters[2]));

  Color_t color[3] = {kRed+2-9, kSpring-2, kBlue+2};
