...
Color_t colorfit[]={kBlue, kRed, kGreen+2, kMagenta+1, kYellow+2, kTeal-5, kMagenta+2, kAzure-7, kBlack};
	      ...
	      )
{
  ...
  if (backgndType==EbackgndType::kTrue){
    fileout.Form("roofit/%sfitTrue_%s_%3.2f-%3.2f_%s",(isRebin? "rebin_" : ""),function.Data(),massRangeMin,massRangeMax,infilename.Data());
		  ...
		  )
{
  ...
  */
  ...
  RooRealVar width("width","width",pdgWidth, 0.0020, 10*pdgWidth);
