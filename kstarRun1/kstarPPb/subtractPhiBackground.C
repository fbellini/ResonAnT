...
const Double_t invMassBinWidth=0.0; //GeV/c^2
...
//---------------------------------------------------------------------------------
TH1D* subtractMixingBackgnd(TH1D* hist, TH1D* hist2, Float_t factor)
{
...
//---------------------------------------------------------------------------------
TH1D* subtractLikeSignBackgnd(TH1D* hist, TH1D* hist2, Float_t factor)
{  
  if ((!hist)||(!hist2)){
...
//---------------------------------------------------------------------------------
TH1D* normValuesInterval(TH1D* hist, TH1D* histRef, Double_t valueMin, Double_t valueMax, Double_t factor)
{
...
//---------------------------------------------------------------------------------
TH1D* normValuesInterval_old(TH1D* hist, TH1D* histRef, Double_t valueMin, Double_t valueMax, Double_t factor)
{
