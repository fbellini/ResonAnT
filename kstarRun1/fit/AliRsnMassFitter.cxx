...
#include "AliRsnMassFitter.h"
#include "AliVertexingRsnUtils.h"


using std::cout;
using std::endl;

ClassImp(AliRsnMassFitter)

 //************** constructors
AliRsnMassFitter::AliRsnMassFitter() : 
  TNamed(),
  fhistoInvMass(0),
  fminMass(0),
  fmaxMass(0),
...
AliRsnMassFitter::AliRsnMassFitter (const TH1F *histoToFit, Double_t minvalue, Double_t maxvalue, Int_t rebin,Int_t fittypeb,Int_t fittypes): 
 TNamed(),
 fhistoInvMass(0),
 fminMass(0),
 fmaxMass(0),
...
AliRsnMassFitter::AliRsnMassFitter(const AliRsnMassFitter &mfit):
  TNamed(),
...
AliRsnMassFitter::~AliRsnMassFitter() {
  ...
  cout<<"AliRsnMassFitter destructor called"<<endl;
...
AliRsnMassFitter& AliRsnMassFitter::operator=(const AliRsnMassFitter &mfit){
...
void AliRsnMassFitter::ComputeNFinalPars() {
...
void AliRsnMassFitter::ComputeParSize() {
...
//___________________________________________________________________________
void AliRsnMassFitter::SetDefaultFixParam(){
...
//___________________________________________________________________________
Bool_t AliRsnMassFitter::SetFixThisParam(Int_t thispar,Bool_t fixpar){
...
//___________________________________________________________________________
Bool_t AliRsnMassFitter::GetFixThisParam(Int_t thispar)const{
...
//___________________________________________________________________________
void AliRsnMassFitter::SetHisto(const TH1F *histoToFit){
...
void AliRsnMassFitter::SetType(Int_t fittypeb, Int_t fittypes) {
...
void AliRsnMassFitter::InitNtuParam(TString ntuname) {
...
void AliRsnMassFitter::FillNtuParam() {
...
TNtuple* AliRsnMassFitter::NtuParamOneShot(TString ntuname){
...
void AliRsnMassFitter::RebinMass(Int_t bingroup){
...
Double_t AliRsnMassFitter::FitFunction4MassDistr (Double_t *x, Double_t *par){
...
//_________________________________________________________________________
Double_t AliRsnMassFitter::FitFunction4Sgn (Double_t *x, Double_t *par){
...
Double_t AliRsnMassFitter::FitFunction4Bkg (Double_t *x, Double_t *par){
...
//__________________________________________________________________________
Bool_t AliRsnMassFitter::SideBandsBounds(){
...
void AliRsnMassFitter::GetSideBandsBounds(Int_t &left, Int_t &right) const{
...
//__________________________________________________________________________
Bool_t AliRsnMassFitter::CheckRangeFit(){
...
Bool_t AliRsnMassFitter::MassFitter(Bool_t draw){  
  ...
  TF1 *funcbkg = new TF1(bkgname.Data(),this,&AliRsnMassFitter::FitFunction4Bkg,fminMass,fmaxMass,bkgPar,"AliRsnMassFitter","FitFunction4Bkg");
 ...
 case 5:
  ...
  if (ftypeOfFit4Sgn == 1) {
    ...
    funcbkg1 = new TF1(bkg1name.Data(),this,&AliRsnMassFitter::FitFunction4Bkg,fminMass,fmaxMass,bkgPar,"AliRsnMassFitter","FitFunction4Bkg");
 ...
 switch (ftypeOfFit4Bkg) {
  ...
  TF1 *funcmass = new TF1(massname.Data(),this,&AliRsnMassFitter::FitFunction4MassDistr,fminMass,fmaxMass,fNFinalPars,"AliRsnMassFitter","FitFunction4MassDistr");
...
Bool_t AliRsnMassFitter::RefitWithBkgOnly(Bool_t draw){
  ...
  TF1* funcbkg = new TF1(bkgname.Data(),this,&AliRsnMassFitter::FitFunction4Bkg,fminMass,fmaxMass,fNFinalPars-3,"AliRsnMassFitter","FitFunction4Bkg");
...
//_________________________________________________________________________
Double_t AliRsnMassFitter::GetChiSquare() const{
  //Get Chi^2 method
...
//_________________________________________________________________________
Double_t AliRsnMassFitter::GetReducedChiSquare() const{
...
//_________________________________________________________________________
void  AliRsnMassFitter::GetFitPars(Float_t *vector) const {
...
//_________________________________________________________________________
void AliRsnMassFitter::IntS(Float_t *valuewitherror) const {

  //gives the integral of signal obtained from fit parameters
  if(!valuewitherror) {
    printf("AliRsnMassFitter::IntS: got a null pointer\n");
    return;
  }
...
//_________________________________________________________________________
void AliRsnMassFitter::AddFunctionsToHisto(){
  ...
  if(!done1){
    ...
    bkgname += "FullRange";
    TF1 *bfullrange=new TF1(bkgname.Data(),this,&AliRsnMassFitter::FitFunction4Bkg,fminMass,fmaxMass,fNFinalPars-3,"AliRsnMassFitter","FitFunction4Bkg");
    ...
    TF1 *blastpar=new TF1(bkgnamesave.Data(),this,&AliRsnMassFitter::FitFunction4Bkg,fminMass,fmaxMass,fNFinalPars-3,"AliRsnMassFitter","FitFunction4Bkg");
...
TH1F* AliRsnMassFitter::GetHistoClone() const{
...
void AliRsnMassFitter::WriteHisto(TString path) const {

  //Write the histogram in the default file RsnMassFitterOutput.root
...
void AliRsnMassFitter::WriteNtuple(TString path) const{
...
//_________________________________________________________________________
void AliRsnMassFitter::WriteCanvas(TString userIDstring,TString path,Double_t nsigma,Int_t writeFitInfo,Bool_t draw) const{
...
TVirtualPad* AliRsnMassFitter::GetPad(Double_t nsigma,Int_t writeFitInfo)const{
...
void AliRsnMassFitter::PlotFit(TVirtualPad* pd,Double_t nsigma,Int_t writeFitInfo)const{
...
void AliRsnMassFitter::DrawHere(TVirtualPad* pd,Double_t nsigma,Int_t writeFitInfo) const {
...
//_________________________________________________________________________
void AliRsnMassFitter::DrawFit(Double_t nsigma) const{
...
void AliRsnMassFitter::PrintParTitles() const{
...
void AliRsnMassFitter::Signal(Double_t nOfSigma,Double_t &signal,Double_t &errsignal) const {
...
void AliRsnMassFitter::Signal(Double_t min, Double_t max, Double_t &signal,Double_t &errsignal) const {
  ...
  if(!funcmass){
    cout<<"AliRsnMassFitter::Signal() ERROR -> Mass distr function not found!"<<endl;
    return;
  }
  ...
  if(!funcbkg){
    cout<<"AliRsnMassFitter::Signal() ERROR -> Bkg function not found!"<<endl;
    return;
  }
...
void AliRsnMassFitter::Background(Double_t nOfSigma,Double_t &background,Double_t &errbackground) const {
...
void AliRsnMassFitter::Background(Double_t min, Double_t max, Double_t &background,Double_t &errbackground) const {
  ...
  if(!funcbkg){
    cout<<"AliRsnMassFitter::Background() ERROR -> Bkg function not found!"<<endl;
    return;
  }
...
void AliRsnMassFitter::Significance(Double_t nOfSigma,Double_t &significance,Double_t &errsignificance) const  {
...
void AliRsnMassFitter::Significance(Double_t min, Double_t max, Double_t &significance,Double_t &errsignificance) const {
  ...
  AliVertexingRsnUtils::ComputeSignificance(signal,errsignal,background,errbackground,significance,errsignificance);
