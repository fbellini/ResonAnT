...
export resBg=$3
export tpcpid="tpc3s_tof3sveto" #"combOldBins"  #"combined" #25s
export normLike=0
wmin=0.5
wmax=1.5
#Nmax=0
...
root -q -l -b "${KSTARFITMACROPATH}/${KSTARFITMACRO}(\"proj/${tpcpid}_centBin00.root\", ${bg}, \"BW+${resBg}\", 0.74, 1.10, ${normLike}, 0, 1, 313, 7.0, 1, 14, 15, 0, ${fixgamma},  ${wmin}, ${wmax})"
else
fi
...
root -q -l -b "${KSTARFITMACROPATH}/${KSTARFITMACRO}(\"proj/${tpcpid}_centBin01.root\", ${bg}, \"BW+${resBg}\", 0.70, 1.10, ${normLike}, 0, 1, 313, 7.0, 1, 13, 15, 1, ${fixgamma},  ${wmin}, ${wmax})"
...
root -q -l -b "${KSTARFITMACROPATH}/${KSTARFITMACRO}(\"proj/${tpcpid}_centBin02.root\", ${bg}, \"BW+${resBg}\", 0.70, 1.10, ${normLike}, 0, 1, 313, 7.0, 1,  4, 15, 2, ${fixgamma},  ${wmin}, ${wmax})"
...
root -q -l -b "${KSTARFITMACROPATH}/${KSTARFITMACRO}(\"proj/${tpcpid}_centBin03.root\", ${bg}, \"BW+${resBg}\", 0.76, 1.06, ${normLike}, 0, 1, 313, 7.0, 1, 13, 15, 3, ${fixgamma},  ${wmin}, ${wmax})"
...
root -q -l -b "${KSTARFITMACROPATH}/${KSTARFITMACRO}(\"proj/${tpcpid}_centBin04.root\", ${bg}, \"BW+${resBg}\", 0.70, 1.10, ${normLike}, 0, 1, 313, 7.0, 1, 11, 12, 4, ${fixgamma},  ${wmin}, ${wmax})"
