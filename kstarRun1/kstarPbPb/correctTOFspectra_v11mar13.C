void correctTOFspectra(TString spectraFileName, Bool_t applyPIDcorr=0){
  ...
  Float_t branchingRatio = 1./0.666;
  ...
  newName.ReplaceAll(".root","_v11mar13.root");
  ...
  for (Int_t ic = 0; ic<4;ic++){
    ...
    heff->Scale(1./2.);//to account for particle and antiparticle
